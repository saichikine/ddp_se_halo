...
static emlrtRSInfo pd_emlrtRSI = { 50, /* lineNo */
  "xzlarf",                            /* fcnName */
  "C:\\Program Files\\MATLAB\\R2019a\\toolbox\\eml\\eml\\+coder\\+internal\\+reflapack\\xzlarf.m"/* pathName */
};

static emlrtRSInfo qd_emlrtRSI = { 68, /* lineNo */
  "xzlarf",                            /* fcnName */
  "C:\\Program Files\\MATLAB\\R2019a\\toolbox\\eml\\eml\\+coder\\+internal\\+reflapack\\xzlarf.m"/* pathName */
};

static emlrtRSInfo rd_emlrtRSI = { 75, /* lineNo */
  "xzlarf",                            /* fcnName */
  "C:\\Program Files\\MATLAB\\R2019a\\toolbox\\eml\\eml\\+coder\\+internal\\+reflapack\\xzlarf.m"/* pathName */
};

static emlrtRSInfo sd_emlrtRSI = { 103,/* lineNo */
  "ilazlc",                            /* fcnName */
  "C:\\Program Files\\MATLAB\\R2019a\\toolbox\\eml\\eml\\+coder\\+internal\\+reflapack\\xzlarf.m"/* pathName */
};
...
void b_xzlarf(const emlrtStack *sp, int32_T m, int32_T n, int32_T iv0, const
              creal_T tau, creal_T C[36], int32_T ic0, creal_T work[6])
{
  int32_T lastv;
  int32_T lastc;
  creal_T b_tau;
  ...
  if ((tau.re != 0.0) || (tau.im != 0.0)) {
    ...
    st.site = &pd_emlrtRSI;
    lastc = b_ilazlc(&st, lastv, n, C, ic0, 6);
  } else {
    lastv = 0;
    lastc = 0;
  }
            ...
            real_T C[36], int32_T ic0, real_T work[6])
{
  ...
  if (tau != 0.0) {
    ...
    st.site = &pd_emlrtRSI;
    lastc = ilazlc(&st, lastv, n, C, ic0, 6);
  } else {
    lastv = 0;
    lastc = 0;
  }
