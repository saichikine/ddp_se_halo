 ...
 *
 * _coder_trqp_multipliers_api.c
 *
 * Code generation for function '_coder_trqp_multipliers_api'
 *
 */
  ...
  [36])
{
  const mxArray *y;
  const mxArray *m16;
  static const int32_T iv15[2] = { 6, 6 };
...
void trqp_multipliers_api(const mxArray *prhs[4], int32_T nlhs, const mxArray
  *plhs[3])
{
  ...
  trqp_multipliers(&st, *H, *g, delta, *M, s_out, H_out, &bool_TRQP_failure);
...
/* End of code generation (_coder_trqp_multipliers_api.c) */
