...
void b_xscal(const emlrtStack *sp, int32_T n, const creal_T a, creal_T x[36],
             int32_T ix0)
{
  int32_T b;
  int32_T k;
...
void c_xscal(const emlrtStack *sp, int32_T n, const creal_T a, creal_T x[36],
             int32_T ix0)
{
  int32_T b;
  int32_T k;
...
void d_xscal(const emlrtStack *sp, const creal_T a, creal_T x[36], int32_T ix0)
{
  int32_T b;
  int32_T k;
  real_T x_re;
