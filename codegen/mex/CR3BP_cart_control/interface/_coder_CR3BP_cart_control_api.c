 ...
 *
 * _coder_CR3BP_cart_control_api.c
 *
 * Code generation for function '_coder_CR3BP_cart_control_api'
 *
 */
  ...
  const emlrtMsgIdentifier *msgId))[10]
{
  ...
  void CR3BP_cart_control_api(const mxArray * const prhs[5], int32_T nlhs, const
  mxArray *plhs[1])
{
  real_T (*Xdot)[10];
  real_T t;
  ...
  Xdot = (real_T (*)[10])mxMalloc(sizeof(real_T [10]));
  ...
  CR3BP_cart_control(&st, t, *X, mu, c, Tmax, *Xdot);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(*Xdot);
}

/* End of code generation (_coder_CR3BP_cart_control_api.c) */
