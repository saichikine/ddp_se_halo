  ...
  const emlrtMsgIdentifier *msgId))[6]
{
  ...
  void CR3BP_fast_api(const mxArray *prhs[3], int32_T nlhs, const mxArray *plhs
                      [1])
{
  real_T (*X_dot)[6];
  ...
  X_dot = (real_T (*)[6])mxMalloc(sizeof(real_T [6]));
  ...
  CR3BP_fast(&st, t, *X, mu, *X_dot);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(*X_dot);
}

/* End of code generation (_coder_CR3BP_fast_api.c) */
